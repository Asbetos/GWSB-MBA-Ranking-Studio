...
export const MODEL_META = {
  elasticnet: {
    label: 'ElasticNet',
    short: 'Linear',
    description: 'Penalized linear regression. Interpretable coefficients; best at additive effects.',
  ...
  randomforest: {
    label: 'Random Forest',
    short: 'RF',
    description: 'Bagged decision trees. Captures non-linear interactions without overfitting.',
  ...
  gradientboost: {
    ...
    short: 'GBM',
    description: 'Sequential boosted trees. Strong fit; sensitive to noise but well-regularized here.',
  ...
  mlp: {
    ...
    short: 'MLP',
    description: '3-layer MLP (64→32→16, ReLU). The "deep learning" branch.',
    cssClass: 'model-mlp',
    color: '#fb7185',
  },
  stacked: {
    ...
    short: 'Ensemble',
    description: 'Ridge meta-learner over the 4 base models. Typically the best out-of-sample fit.',
