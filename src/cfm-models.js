...
/**
 * For each lever key, find the CFM target where it has the highest |coefficient|.
 * Cached. Returns { leverKey: { target, coef, absCoef } }.
 */
...
/**
 * For a given target, return its CFM's top-k features by |coefficient|, with
 * each feature's % contribution to the prediction (|coef| / Σ|coef|).
 */
